<?php
  ...
  $sentencia = mysql_query($listado,$conn);
  while($rs=mysql_fetch_array($sentencia,$mibase)){
    $titulo_tasaciones = str_replace("\r\n","<br>",$rs["titulo_tasaciones"]); 
    $contenido_tasaciones = str_replace("\r\n","<br>",$rs["contenido_tasaciones"]); 
  }
...
<head>
	...
	<title>Tasaciones Busca Tu Propiedad</title>
...
<body>
	  ...
	  <div class="centro_header">
	    ...
	    <nav id="menu">
	      ...
	      <ul>
	        ...
	        <li><a class="activo" href="tasaciones.php">TASACIONES</a></li>
	...
	<section class="contenido_principal">
		<div class="propiedad">
			<div class="img_propiedad">
				<img src="imagenes/tasaciones/1.jpg">
			</div>
			<div class="textos2">
				<h3><?php echo $titulo_tasaciones ?></h3>
				<p><?php echo $contenido_tasaciones ?></p> <br>
				<br>
				<p>Para mayor información <a style="width:100px;" href="contacto.php">Pinche Aquí</a></p>	
			</div>
		</div>
	</section>
	<section class="contenido_secundario">
		...
		<section class="contacto">
			<form class="formulario" action="tasaciones.php" method="post" onSubmit="MM_validateForm('name','','R','message','','R');return document.MM_returnValue;return document.MM_returnValue">
